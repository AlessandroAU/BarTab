...
`bartab.png` is the original artwork generated with the built-in image generation tool. `bartab.ico` contains 16, 24, 32, 48, 64, 128 and 256 pixel variants, embedded in the executable and used for window and tray icons.
...
```bat
magick assets/bartab.png -define icon:auto-resize=256,128,64,48,32,24,16 assets/bartab.ico
```
