...
struct Appearance {
    ...
    auto values() const { return std::tie(text_percent,font,accent,theme,widget_width,hover_width,hover_opacity,hover_delay,bar_height,corner_radius,position,show_resets,hover_enabled); }
    ...
    void normalize() {
        ...
        hover_opacity=std::clamp(hover_opacity,50,100); hover_delay=std::clamp(hover_delay,50,1500);
